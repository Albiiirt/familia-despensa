...
import { Minus, Plus, Star, MoreVertical, Pencil, Trash2 } from 'lucide-react';
...
export function ItemCard({ item, onAdjust, onToggleFavorite, onEdit, onDelete }: Props) {
              ...
              <div className="relative">
                ...
                {menuOpen && (
                  <>
                    ...
                    <div className="absolute right-0 top-7 z-20 bg-white rounded-xl shadow-lg border border-slate-100 overflow-hidden min-w-[130px]">
                      <button
